...
public class Question4 {
    ...
    public static int getDaysInMonth(int month, int year) {
        ...
        if (isLeapYear) {
            switch (month) {
                ...
                case 10:
                case 12:
                    daysInMonth = 31; // All of these months have 31 days
                    break;
                case 2:
                    daysInMonth = 29; // February has 29 days in leap year
                    break;
                case 4:
                case 6:
                case 9:
                case 11:
                    daysInMonth = 30; // All of these months have 30 days
                    break;
            }
        } else {
            switch (month) {
                ...
                case 12:
                    ...
                    break;
                case 2:
                    daysInMonth = 28; // February has 28 days on a non-leap year
                    break;
                case 4:
                case 6:
                case 9:
    ...
    public static void main(String[] args) {
        ...
        int year = in.nextInt();
        System.out.println("Days in month is " + getDaysInMonth(month, year));
        in.close();
    }
}
